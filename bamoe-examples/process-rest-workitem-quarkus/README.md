...
There are two ways to invoke a rest web service in Kogito: programmatically, as shown in this other [example](https://github.ibm.com/dba/bamoe-examples/tree/9.2.1/process-service-calls-quarkus) or using RestWorkItemHandler, as in this example.
