...
./bamoe-maven/scripts/create-decision-servce.sh my-decision-service "-DuseFactModel=true -DfactModelGroupId=com.ibm.edu.bamoe.workshop.student -DfactModelArtifactId=my-fact-model -DfactModelVersion=1.0.0-SNAPSHOT"
```
